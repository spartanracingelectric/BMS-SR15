...
static uint8_t config[8][6] =
		{ { 0xF8, 0x00, 0x00, 0x00, 0x00, 0xF0 }, { 0xF8, 0x00, 0x00, 0x00,
				0x00, 0xF0 }, { 0xF8, 0x00, 0x00, 0x00, 0x00, 0xF0 }, { 0xF8,
				0x00, 0x00, 0x00, 0x00, 0xF0 }, { 0xF8, 0x00, 0x00, 0x00, 0x00,
				0xF0 }, { 0xF8, 0x00, 0x00, 0x00, 0x00, 0xF0 }, { 0xF8, 0x00,
				0x00, 0x00, 0x00, 0xF0 }, { 0xF8, 0x00, 0x00, 0x00, 0x00, 0xF0 } };

static uint8_t defaultConfig[8][6] = { { 0xF8, 0x00, 0x00, 0x00, 0x00, 0xF0 }, {
		0xF8, 0x00, 0x00, 0x00, 0x00, 0xF0 }, { 0xF8, 0x00, 0x00, 0x00, 0x00,
		0xF0 }, { 0xF8, 0x00, 0x00, 0x00, 0x00, 0xF0 }, { 0xF8, 0x00, 0x00,
		0x00, 0x00, 0xF0 }, { 0xF8, 0x00, 0x00, 0x00, 0x00, 0xF0 }, { 0xF8,
