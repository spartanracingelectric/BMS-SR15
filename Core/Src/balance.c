...
static uint8_t config[8][6] =
		{ { 0xF8, 0x00, 0x00, 0x00, 0x00, 0x40 }, { 0xF8, 0x00, 0x00, 0x00,
				0x00, 0x40 }, { 0xF8, 0x00, 0x00, 0x00, 0x00, 0x40 }, { 0xF8,
				0x00, 0x00, 0x00, 0x00, 0x40 }, { 0xF8, 0x00, 0x00, 0x00, 0x00,
				0x40 }, { 0xF8, 0x00, 0x00, 0x00, 0x00, 0x40 }, { 0xF8, 0x00,
				0x00, 0x00, 0x00, 0x40 }, { 0xF8, 0x00, 0x00, 0x00, 0x00, 0x40 } };

static uint8_t defaultConfig[8][6] = { { 0xF8, 0x00, 0x00, 0x00, 0x00, 0x40 }, {
		0xF8, 0x00, 0x00, 0x00, 0x00, 0x40 }, { 0xF8, 0x00, 0x00, 0x00, 0x00,
		0x40 }, { 0xF8, 0x00, 0x00, 0x00, 0x00, 0x40 }, { 0xF8, 0x00, 0x00,
		0x00, 0x00, 0x40 }, { 0xF8, 0x00, 0x00, 0x00, 0x00, 0x40 }, { 0xF8,
		0x00, 0x00, 0x00, 0x00, 0x40 }, { 0xF8, 0x00, 0x00, 0x00, 0x00, 0x40 } };
